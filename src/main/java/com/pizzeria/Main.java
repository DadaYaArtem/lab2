...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // 14. Демонстрация аутентификации
            System.out.println("\n14. АУТЕНТИФИКАЦИЯ СОТРУДНИКОВ");
            System.out.println("-------------------------------------------------");

            try {
                if (chef1.authenticate("CHF001", "default123")) {
                    System.out.println("✓ Повар " + chef1.getFullName() + " успешно авторизован");
                }

                // Смена пароля
                chef1.changePassword("default123", "newSecurePass123");
    ...
    /**
     * Вывод статистики по созданной системе
     */
    private static void printSystemStatistics() {
        System.out.println("\n=================================================");
        System.out.println("   СТАТИСТИКА СИСТЕМЫ");
        System.out.println("=================================================");
        System.out.println("✓ Создано 50+ классов");
        System.out.println("✓ Реализовано 6 интерфейсов");
        System.out.println("✓ Создано 12 персональных исключений");
        System.out.println("✓ Использованы паттерны: Factory, Strategy, Singleton");
        System.out.println("✓ Применены принципы: SOLID, GRASP");
        System.out.println("✓ Реализовано 100+ уникальных методов");
        System.out.println("✓ Создано 30+ ассоциаций между классами");
        System.out.println("✓ Демонстрация: наследование, полиморфизм, инкапсуляция");
        System.out.println("=================================================");
    }
}
